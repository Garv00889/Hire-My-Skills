...
import { loginUser, getMeWithToken } from '../services/api';
...
const LoginPage = () => {
  ...
  // 🔹 Google OAuth Token Receiver Logic
  useEffect(() => {
    ...
    const handleGoogleLogin = async () => {
      try {
        const response = await getMeWithToken(googleToken);
        login(response.data, googleToken);
        window.history.replaceState({}, document.title, '/login');
      ...
      <div className="login-right">
        <div className="login-card">
          ...
          <div className="oauth-buttons">
            <button id="google-login" className="oauth-btn" type="button" onClick={() => window.location.href = 'https://hire-my-skills.onrender.com/api/auth/google'}>
            ...
            <button id="github-login" className="oauth-btn" type="button" onClick={() => window.location.href = 'http://localhost:5000/api/auth/github'}>
